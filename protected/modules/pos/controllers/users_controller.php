...
class UsersController extends BaseController
{
    ...
    public function accessRules()
    {
        return [
            ...
            ['allow',
                'actions' => ['view', 'group'],
                'expression' => $this->hasAccess('pos/users/read'),
            ],
            ['allow',
                'actions' => ['create', 'group/create', 'group/priviledge'],
                'expression' => $this->hasAccess('pos/users/create'),
            ],
            ['allow',
                'actions' => ['update', 'group/update'],
                'expression' => $this->hasAccess('pos/users/update'),
            ],
            ['allow',
                'actions' => ['delete', 'group/delete'],
                'expression' => $this->hasAccess('pos/users/delete'),
            ],
            ['deny',
                'users' => ['*'],
            ],
