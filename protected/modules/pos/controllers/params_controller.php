...
class ParamsController extends BaseController
{
    ...
    public function accessRules()
    {
        return [
            ...
            ['allow',
                'actions' => ['view'],
                'expression' => $this->hasAccess('pos/params/read'),
            ],
            ['allow',
                'actions' => ['create'],
                'expression' => $this->hasAccess('pos/params/create'),
            ],
            ['allow',
                'actions' => ['update'],
                'expression' => $this->hasAccess('pos/params/update'),
            ],
            ['allow',
                'actions' => ['delete'],
                'expression' => $this->hasAccess('pos/params/delete'),
            ],
            ['deny',
                'users' => ['*'],
            ],
    ...
    public function create($request, $response, $args)
    {
        ...
        if (isset($_POST['Options'])){
            ...
            if ($create) {
                ...
                $hooks = new \Pos\Components\AdminHooks($this->_settings);
